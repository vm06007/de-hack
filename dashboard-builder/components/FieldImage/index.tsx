    ...
    return (
        <div className={`${className || ""}`}>
            ...
            {preview ? (
                ...
                <div className="relative flex flex-col justify-center items-center h-50 bg-b-surface3 border border-transparent rounded-4xl overflow-hidden transition-colors hover:border-s-highlight">
                    <input
                        ref={inputRef}
                        type="file"
