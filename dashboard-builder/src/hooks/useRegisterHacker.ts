...
export const useRegisterHacker = (contractAddress: string) => {
    ...
    useEffect(() => {
        if (error) {
            console.log("Hacker registration writeContract error:", error);
            ...
            if (errorMessage.includes('User rejected') ||
                ...
                toast.error("Transaction cancelled by user", { id: "register-hacker" });
            } else {
                // console.error("Registration transaction error:", error);
                toast.error(`Registration failed: ${errorMessage}`, { id: "register-hacker" });
            }
