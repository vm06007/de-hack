...
/**
 * @title HackathonJudgeTest
 * @dev Hardhat-compatible tests for Hackathon judge functionality
 */
contract HackathonJudgeTest {
    ...
    function testJudgeSetup() public view {
        console.log("Testing judge setup...");
        ...
        require(judge3 != address(0), "Judge3 should not be zero address");
        ...
        require(organizer != judge1, "Organizer should be unique");
        require(judge1 != judge2, "Judges should be unique");
        require(judge2 != judge3, "Judges should be unique");
        require(participant1 != participant2, "Participants should be unique");
        
        console.log("Judge setup test passed");
    }

    function testJudgeValidation() public view {
        ...
        require(judges.length == 3, "Should have 3 judges");
        require(judges[0] == judge1, "First judge should match");
        require(judges[1] == judge2, "Second judge should match");
        require(judges[2] == judge3, "Third judge should match");
        
        // Test that all judges are unique
        require(judges[0] != judges[1], "Judges should be unique");
        require(judges[1] != judges[2], "Judges should be unique");
        require(judges[0] != judges[2], "Judges should be unique");
        
        console.log("Judge validation test passed");
    }
