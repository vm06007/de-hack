...
/**
 * @title HackathonPrizeTest
 * @dev Hardhat-compatible tests for Hackathon prize functionality
 */
contract HackathonPrizeTest {
    ...
    function testPrizeSetup() public view {
        console.log("Testing prize setup...");
        ...
        console.log("Prize setup test passed");
    }
